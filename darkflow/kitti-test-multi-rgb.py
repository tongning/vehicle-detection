...
def main(argv):
    ...
    #directory_l = os.path.join("/home/eric/vehicle-detection/data/KITTI-detection-depth/image_2/")
    directory_l = os.path.join("/home/eric/vehicle-detection/data/KITTI-tracking/training/image_02/", sequence_number)
